...
_DEV_SECRET_KEY = "dev-only-change-me-in-production-use-env-32"
...
class Settings(BaseSettings):
    ...
    DATABASE_URL: PostgresDsn = Field(
            default_factory=lambda: PostgresDsn(
                "postgresql+asyncpg://postgres:6.11.2004@localhost/postgres"
            ),
    ...
    DATABASE_REDIS_URL: str = "redis://localhost:6379/0"
    EXP_KEY_PROXY: int = 60 * 60 * 24
